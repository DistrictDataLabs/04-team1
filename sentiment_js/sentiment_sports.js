...
//  var color = d3.rgb(12, 67, 199);  // Red, Green, Blue
 // var color = d3.hsl(0, chart7100, 50);  //  Hue-Saturation-Lightness  (e.g. red)
...
var tooltip = d3.select("body").append("div")
    ...
    // load data
d3.csv("js/stories_with_links_sports.csv", function(error, data) {
   ...
   //       .style("fill", function(d) { return color(d.category);})
          ...
          .on("mouseover", function(d) {
              tooltip.transition()
                   .duration(200)
                   .style("opacity", .9);
              tooltip.html(d.title + "<br/> (" + xValue(d) + " , " + yValue(d) + " , " + d.date + ")")
      ...
      // draw legend
//      var legend = chart7.selectAll(".legend")
//          .data(color.domain())
//        .enter().append("g")
//          .attr("class", "legend")
